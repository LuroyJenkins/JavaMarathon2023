...
public class Task2 {
    public static void main(String[] args) {
        Player player1 = new Player(ThreadLocalRandom.current().nextInt(90, 101));
        Player player2 = new Player(ThreadLocalRandom.current().nextInt(90, 101));
        Player player3 = new Player(ThreadLocalRandom.current().nextInt(90, 101));
        Player player4 = new Player(ThreadLocalRandom.current().nextInt(90, 101));
        Player player5 = new Player(ThreadLocalRandom.current().nextInt(90, 101));
        Player player6 = new Player(ThreadLocalRandom.current().nextInt(90, 101));
